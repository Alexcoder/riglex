...
const BumpPressure = () => {
  ...
  return (
    <Container sx={{textAlign: "center", alignItems:"center",justifyContent:"center",color: "blue", background:"gray", width: "100vw",paddingTop:"2rem",paddingBottom:"2rem", margin:{md:"1rem 0rem 0rem 15%", sm:"0.5rem 0rem 0rem 0rem", xs:"0.5rem 0rem 0rem 0rem"},}}>
