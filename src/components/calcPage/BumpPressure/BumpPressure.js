...
const BumpPressure = () => {
  ...
  return (
    <Container sx={{textAlign: "center", alignItems:"center",justifyContent:"center",color: "blue", background:"gray", width: "100vw",paddingTop:"2rem",paddingBottom:"2rem", margin:{md:"1rem 0rem 0rem 15%", sm:"1rem 0rem 0rem 0rem", xs:"1rem 0rem 0rem 0rem"},}}>
      <Paper elevation={5} sx={{padding: "1rem 1rem 2rem 1rem", width: {md:"75%", sm:"95%", xs: "95%" },}}>
