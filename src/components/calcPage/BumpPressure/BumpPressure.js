...
const BumpPressure = () => {
  ...
  return (
    <Container sx={{textAlign: "center", alignItems:"center",justifyContent:"center",color: "blue", background:"gray", width: "100vw",padding:"2rem 0rem", margin:{md:"1rem 0rem 0rem 15%", sm:"1rem 0rem 0rem 0rem", xs:"2rem 0rem 0rem 0rem"},}}>
